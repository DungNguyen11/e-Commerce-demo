...
const ToiletteProductPage = () => {
  ...
  useEffect(() => {
    dispatch(getProductListAction({ limit: PAGE_SIZE.USER_PRODUCT, page: 1, type: "toilette"}))
...
export default ToiletteProductPage
